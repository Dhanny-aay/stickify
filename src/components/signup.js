    ...
    return ( 
        <div className=" bg-[#f1f1f1] w-full h-[100vh] lg:py-[8%] lg:px-[15%]">
            <div className=" w-full h-full bg-transparent shadow flex flex-row">
                ...
                <div className=" lg:w-1/2 w-full h-full lg:bg-[#fff] bg-[#fdd037] flex flex-col items-center justify-center lg:justify-start rounded-r-md p-8 space-y-5 relative">
                <span className=" flex lg:hidden flex-row space-x-1  font-bold font-Tilt text-xl text-[#000]"><p>Stickify</p><p className=" text-[#fff]">.</p></span>
                    ...
                    <div className=" space-y-6 w-full md:w-[350px] lg:w-full">
                        <input id="name" className=" w-full p-2 rounded-md font-normal text-sm font-Labrada bg-[#f1f1f1]" placeholder="Full-Name" type="text" />
                    ...
                    <button className=" flex justify-center space-x-2 items-center w-full md:w-[350px] lg:w-full rounded-md py-2 font-Labrada text-white text-sm font-bold bg-[#000] hover:bg-opacity-70">Sign Up
